...
import { isDeliverableInvoice } from '@/lib/invoice/delivery';
...
export function SidebarButton({
  ...
  return (
    <button
      ...
      className={cn(
        'w-full flex items-center gap-2.5 px-3.5 py-2.5 text-xs font-semibold rounded-xl transition-all',
  ...
  return (
    <div className="w-full space-y-3 pb-8 print:hidden">
      ...
      <div className="bg-white rounded-2xl border border-slate-200 p-3 space-y-2 shadow-sm">
        <p className="text-[9px] font-black uppercase tracking-[0.15em] text-slate-400 px-0.5 mb-2">Export</p>
        <SidebarButton
          icon={FileDown}
